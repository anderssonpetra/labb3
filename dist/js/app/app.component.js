        ...
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        selector: 'my-app',
                        template: "<div id=\"layout\" [class.active]=\"menuActive\">     <!-- Menu toggle -->     <a id=\"menuLink\" class=\"menu-link\" (click)=\"showHideMenu()\">         <span></span>     </a> \t<!-- Side menu -->     <div id=\"menu\" [class.active]=\"menuActive\">         <div class=\"pure-menu\">             <a class=\"pure-menu-heading\" href=\"#\">Menu</a>              <ul class=\"pure-menu-list\">                 <li class=\"pure-menu-item\"><a class=\"pure-menu-link\" [class.active]=\"menuActive\" [routerLink]=\"['Home']\"><i class=\"fa fa-chevron-right\"></i> Home</a></li>                 <li class=\"pure-menu-item\"><a class=\"pure-menu-link\" [class.active]=\"menuActive\" [routerLink]=\"['About', {msg: 'jag \u00E4r ett v\u00E4rde'}]\"><i class=\"fa fa-chevron-right\"></i> About</a></li>                 <li class=\"pure-menu-item\"><a class=\"pure-menu-link\" [class.active]=\"menuActive\" [routerLink]=\"['Notes']\"><i class=\"fa fa-chevron-right\"></i> Notes</a></li>                 <li class=\"pure-menu-heading\">more</li>                 <li class=\"pure-menu-item\"><a class=\"pure-menu-link\" [class.active]=\"menuActive\" [routerLink]=\"['Login']\"><i class=\"fa fa-chevron-right\"></i> Login</a></li>                 <li class=\"pure-menu-item\"><a class=\"pure-menu-link\" [class.active]=\"menuActive\" [routerLink]=\"['NewUser']\"><i class=\"fa fa-chevron-right\"></i> New User</a></li>              </ul>          </div>     </div> \t \t<!-- Main content -->     <div id=\"main\">         <div class=\"header\">             <h1>Notetaker</h1>             <h2>Store your notes 4ever</h2>         </div>                  <div class=\"content\">   \t\t\t<!-- Routed views go here --> \t\t\t<router-outlet></router-outlet>         </div> \t\t     </div> </div>",
